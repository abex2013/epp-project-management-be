...
{
    public class EducationProgrammeRepository : AsyncRepository<EducationProgramme>, IEducationProgrammeRepository
    {
        ...
        public async Task<EducationProgramme> GetByName(string name)
        {
            try
            {

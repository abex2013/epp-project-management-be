...
{
    public class EducationProgrammeService : CRUD<EducationProgrammeEntity, EducationProgramme>, IEducationProgrammeService
    {
        ...
        public async Task<string> GetName(Guid educationProgrammId)
        {

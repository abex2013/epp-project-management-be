...
namespace Excellerent.ResourceManagement.Presentation.Controllers
{
    ...
    [ApiController]
    public class DutyBranchCotroller : AuthorizedController
    {
        private readonly IDutyBranchService _dutyBranchService;
        public DutyBranchCotroller(IHttpContextAccessor htttpContextAccessor, IConfiguration configuration, IBusinessLog _businessLog, IDutyBranchService dutyBranchService) : base(htttpContextAccessor, configuration, _businessLog, "DutyBranch")
        {
        ...
        public async Task<ResponseDTO> UpdateDutyBranch([FromBody] DutyBranchEntity dutyBranch)
        {

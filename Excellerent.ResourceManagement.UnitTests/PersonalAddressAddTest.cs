...
namespace Excellerent.ResourceManagement.UnitTests
{
    ...
    public class PersonalAddressAddTest
    {
        ...
        [Fact]
        public void Test_Add_PersonalAddress_Controller()
        {
            // Arrange
            ...
            ResponseDTO response = controller.Add(personalAddress).Result;

            Assert.Equal(ResponseStatus.Success, response.ResponseStatus);
        }

        [Fact]
        public void Test_Add_PersonalAddress_Service()
        {
            // Arrange
            ...
            ResponseDTO response = service.Add(personalAddress).Result;
